  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Datenschutzerklärung von Barbato Electronics – Informationen zum Schutz Ihrer personenbezogenen Daten gemäß DSGVO."
        ...
        <Card className="border-border/50 shadow-lg">
          <CardContent className="p-8 prose prose-sm max-w-none dark:prose-invert">
            ...
            <p>
              ...
              einem sogenannten Logfile gespeichert. Folgende Informationen werden dabei ohne Ihr Zutun erfasst und bis
            ...
            <p>Sie haben die Möglichkeit, ein Kundenkonto bei uns anzulegen. Hierfür benötigen wir folgende Daten:</p>
            <ul>
            ...
            <p>Wenn Sie eine Bestellung in unserem Online-Shop aufgeben, erheben wir folgende Daten:</p>
            <ul>
            ...
            <p>Die Verarbeitung erfolgt zur Vertragserfüllung gemäß Art. 6 Abs. 1 S. 1 lit. b DSGVO.</p>

            <h2>3. Zahlungsabwicklung über Stripe</h2>
            <p>
              Für die Zahlungsabwicklung nutzen wir den Dienst Stripe (Stripe Payments Europe, Ltd., 1 Grand Canal
              Street Lower, Grand Canal Dock, Dublin, Irland). Bei der Bezahlung werden Ihre Zahlungsdaten direkt an
              Stripe übermittelt. Stripe verarbeitet Ihre Daten gemäß seiner eigenen Datenschutzrichtlinie:{" "}
              <a
            ...
            <p>Rechtsgrundlage hierfür ist Art. 6 Abs. 1 S. 1 lit. b DSGVO (Vertragserfüllung).</p>

            <h2>4. Hosting</h2>
            <p>
              Diese Website wird bei einem externen Dienstleister gehostet (Hoster). Die personenbezogenen Daten, die
              auf dieser Website erfasst werden, werden auf den Servern des Hosters gespeichert. Der Einsatz des Hosters
              erfolgt zum Zwecke der Vertragserfüllung gegenüber unseren potenziellen und bestehenden Kunden (Art. 6
              Abs. 1 lit. b DSGVO) und im Interesse einer sicheren, schnellen und effizienten Bereitstellung unseres
            ...
            <p>
              ...
              Ihrem Endgerät speichert. Cookies helfen uns dabei, unser Angebot nutzerfreundlicher und effektiver zu
              gestalten.
            </p>
            <p>
              Wir verwenden ausschließlich technisch notwendige Cookies, die für den Betrieb der Website erforderlich
              sind (z. B. Session-Cookies für den Warenkorb und die Anmeldung). Die Rechtsgrundlage hierfür ist Art. 6
            ...
            <p>
              ...
              einzelne Seite unseres Internetauftrittes verschlüsselt übertragen wird, erkennen Sie an der geschlossenen
            ...
            <p>
              ...
              steuerrechtliche Aufbewahrungsfristen zu beachten sind, kann die Aufbewahrungsdauer zu bestimmten Daten
