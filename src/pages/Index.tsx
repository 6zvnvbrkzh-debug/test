    ...
    <Layout>
      ...
      <section className="container pb-8 md:pb-12 my-0 px-0">
        <motion.div {...fadeUp(0.05)}>
          ...
          >
            <div className="relative rounded-2xl overflow-hidden border border-primary/20 bg-gradient-to-r from-[hsl(200,80%,50%)]/10 via-[hsl(200,80%,50%)]/5 to-transparent p-6 md:p-8 px-[32px] mt-[16px] mb-[50px]">
