...
const homepageJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": `${BASE_URL}/#store`,
      name: "Barbato Electronics",
      image: `${BASE_URL}/images/b-electronics-logo.webp`,
      url: BASE_URL,
      telephone: "+49-176-22551230",
      priceRange: "€€",
      currenciesAccepted: "EUR",
      paymentAccepted: "Credit Card, Debit Card, Klarna, PayPal, SEPA",
      address: {
        "@type": "PostalAddress",
        streetAddress: "Kemptnerstraße 11",
        addressLocality: "Ulm",
...
const trustItems = [
  ...
  { icon: Headphones, title: "Persönlicher Support", desc: "Mo–Do, 9–20\u00A0Uhr" },
];
